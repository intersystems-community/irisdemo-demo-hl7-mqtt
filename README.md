...
```bash
docker run -it --rm -p 52773:52773 --name iris intersystemsdc/irisdemo-demo-hl7-mqtt:version-1.0.3
```
...
```bash
docker run -it --rm -p 52773:52773 --name iris intersystemsdc/irisdemo-demo-hl7-mqtt:student-version-1.0.3
```
